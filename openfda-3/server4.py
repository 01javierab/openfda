...
class testHTTPRequestHandler(http.server.BaseHTTPRequestHandler):
    ...
    def do_GET(self):#aplicaremos el método GET
        ...
        content = "<html><body style='background-color: green'><ul>" #creamos el html
...
except socket.error:  #Except por si hay algún problema con el puerto
    print("Problemas usando el puerto {}".format(PORT))
    print("Lanzalo en otro puerto")
